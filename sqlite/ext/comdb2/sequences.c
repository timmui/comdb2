                                ...
                                int pos)
{
    ...
    case SEQUENCE_COLUMN_MINVALUE:
        sqlite3_result_int64(ctx, sequence->min_val, -1, NULL);
        break;
    case SEQUENCE_COLUMN_MAXVALUE:
        sqlite3_result_int64(ctx, sequence->max_val, -1, NULL);
        break;
    case SEQUENCE_COLUMN_INCREMENT:
        sqlite3_result_int64(ctx, sequence->increment, -1, NULL);
        break;
    case SEQUENCE_COLUMN_STARTVAL:
        sqlite3_result_int64(ctx, sequence->start_val, -1, NULL);
        break;
    case SEQUENCE_COLUMN_NEXT_STARTVAL:
        sqlite3_result_int64(ctx, sequence->next_start_val, -1, NULL);
        break;
    case SEQUENCE_COLUMN_CHUNK:
        sqlite3_result_int64(ctx, sequence->chunk_size, -1, NULL);
        break;
    default:
        assert(0);
    };
